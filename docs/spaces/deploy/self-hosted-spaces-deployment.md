---
title: Self-hosted Spaces Deployment Guide 
sidebar_position: 1
...
:::importantIf you chose to create a public ingress, you also need to create a DNS record for the load balancer of the public facing ingress. Do this before you create your first control plane.:::
