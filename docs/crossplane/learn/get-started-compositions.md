...
1. [Define][define] the schema of the `App` custom resource
1. [Install][install] the function you want to use to configure
    how Crossplane composes apps
1. [Configure][configure] how Crossplane composes apps

After you complete these steps you can
[use the new `App` custom resource][use-the-new-app-custom-resource].
...
[installing a function][installing-a-function] and
...
full [Python standard library][python-standard-library].
...
```
    ...
    <TabItem value = "KCL">
[KCL][kcl] is a good choice for compositions with dynamic logic.
...
[define]: #define-the-schema
[install]: #install-the-function
[configure]: #configure-the-composition
[use-the-new-app-custom-resource]: #use-the-custom-resource
[installing-a-function]: #install-the-function
