...
* Added a new [Observability View in the WebUI](/manuals/uxp/concepts/observability-views.md) showing dashboards with the state of the UXP installation and managed resources.
