...
Upbound Crossplane requires a Kubernetes cluster. You can run Upbound Crossplane in any Kubernetes environment, whether thats a managed Kubernetes service as well as in bare-metal environments. Upbound recommends using Helm to install a self-managed instance of Upbound Crossplane.
