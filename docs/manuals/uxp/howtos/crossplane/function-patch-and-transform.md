...
<details>
  <summary>Reference Composition</summary>
  ```yaml {copy-lines="all"}
apiVersion: apiextensions.crossplane.io/v1
kind: Composition
metadata:
...
<details>
  <summary>Reference CompositeResourceDefinition</summary>
  ```yaml {copy-lines="all"}
apiVersion: apiextensions.crossplane.io/v1
kind: CompositeResourceDefinition
metadata:
...
<details>
  <summary>Reference EnvironmentConfig</summary>
  ```yaml {copy-lines="all"}
...
<div id="describeCombineFromComp">
```yaml
$ kubectl describe bucket
