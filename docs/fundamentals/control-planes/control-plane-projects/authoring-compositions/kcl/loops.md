...
KCL supports [comprehensions][comprehensions], which lets users construct a list or dictionary value by looping over one or more items and evaluating an expression.
...
For more information on comprehensions, review the [KCL docs][kcl-docs].
...
[kcl-docs]: https://www.kcl-lang.io/docs/reference/lang/spec/expressions#comprehensions
