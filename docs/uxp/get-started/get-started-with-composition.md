...
<TabItem value="Templated_YAML" label="Templated YAML">
...
Read the [guide to writing a composition function in Python](/crossplane/guides/write-a-composition-function-in-python).
:::
...
[the composition documentation](/crossplane/composition/compositions#grant-access-to-composed-resources)
...
[Read the XR page](/crossplane/composition/composite-resources) to learn how to
...
[Get started with managed resources](/crossplane/get-started-with-managed-resources)
