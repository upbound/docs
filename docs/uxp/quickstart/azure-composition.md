...
It's common to use a control plane to define new custom resource types for external resources, such as Azure. This quickstart will guide you through creating and deploying your first custom resource type for Azure on a control plane.
