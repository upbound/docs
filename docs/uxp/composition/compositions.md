...
[patch and transforms](/crossplane/guides/function-patch-and-transform).
Helm-like
...
For example, to install [Function Patch and Transform](/crossplane/guides/function-patch-and-transform),
...
[Packages documentation](/crossplane/packages/functions).
:::
...
This example uses
[Function Patch and Transform](/crossplane/guides/function-patch-and-transform).
...
[Composite Resources page](/crossplane/composite-resources).
:::
...
resource installed by a [provider](/crossplane/packages/providers), or
defined by an XRD. This includes all
[MRs](/crossplane/managed-resources/managed-resources) and
[XRs](/crossplane/composite-resources). It also has access to some types of
...
:::note
The [RBAC manager](/crossplane/guides/pods#rbac-manager-pod) automatically
...
:::tip
See the [Crossplane CLI docs](/crossplane/cli) to
...
runtime the Crossplane CLI ignores the Function's <Hover label="development" line="8">package</Hover>. Instead it expects you to make sure the function
...
Crossplane has [language specific guides](/crossplane/guides) to writing a
