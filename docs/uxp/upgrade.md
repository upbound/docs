...
Find the correct version of UXP to upgrade to from the [UXP releases page][uxp-releases-page].
...
[uxp-releases-page]: https://github.com/upbound/universal-crossplane/releases
