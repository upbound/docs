...
(XR). Read the
[concepts](/crossplane/composition/compositions)
...
[how composition functions work](/crossplane/composition/compositions#how-composition-functions-work)
...
* The [Crossplane CLI](/crossplane/cli) v1.14 or newer. This guide uses Crossplane
  CLI v1.14.
...
The [composition functions](/crossplane/composition/compositions)
...
<details>
  <summary>The full fn.py file</summary>
  ```python
...
<details>
  <summary>The full test_fn.py file</summary>
  ```python
import dataclasses
import unittest
...
[testing composition functions](/crossplane/composition/compositions#test-a-composition).
:::
...
[composition functions documentation](/crossplane/composition/compositions).
