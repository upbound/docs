...
:::note
The [Install Crossplane](/crossplane/get-started/install) section has more
...
[changing the Crossplane pod setting](/crossplane/pods#change-pod-settings)
and enabling  
...
[Crossplane Install](/crossplane/get-started/install) section.
:::
