...
Get started with Upbound in one of four ways:
...
* [Deploy your first managed control plane with Upbound's multicloud CaaS configuration]({{<ref "multicloud-deploy" >}}) - Using Official Providers from Upbound.