...
As an alternative, you can use Kubernetes-compatible [RESTful API]({{<ref "operate/control-planes/#connect-directly-to-your-control-plane">}}) offered by each control plane.
