...
The credentials for the `imagePullSecret` are from an authorized Upbound robot token. Find details on creating robot tokens in the [robot accounts documentation]({{<ref "upbound/upbound-cloud/robot-accounts.md" >}}).
...
More information is available on the [support page]({{<ref "upbound/getting-started/support.md" >}}).
