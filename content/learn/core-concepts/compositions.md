...
Compositions are declarative templates that allow you to creawte multiple
managed resources within a single file. Instead of provisioning resources
individually, you can combine multiple resources into a reusable solution that
...
Compsite Resource Definitions (XRDs) and Compositions are structures to help you
