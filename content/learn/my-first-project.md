...
control plane project (upbound-hello-world) by default.

```shell
up ctx ./upbound-hello-world
```
...
up project build
```
This command takes your project's dependencies and metadata and compiles it into a single OCI image at `_output/upbound-hello-world-1.uppkg`.
