...
{{<expand "View the example export" >}}
```bash
$ up alpha migration export
...
[configuration-aws-network](https://marketplace.upbound.io/configurations/upbound/configuration-aws-network) is show below:

{{<expand "View the example cluster content" >}}
```bash
...
{{<expand "View the migration import" >}}
```bash
