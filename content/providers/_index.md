...
The Upbound official providers are open source under the [Apache 2.0 license]({{<ref "policies.md#license" >}}).

<!-- vale write-good.Passive = NO -->
The following providers are designated Upbound Official and are subject to
Upbound's [publishing and access policies]({{<ref "policies.md#access" >}}).
...
You will find the Official providers in the [Upbound Marketplace](https://marketplace.upbound.io/providers?tier=official) where
all Official providers are identified by an `Official` tag.

Read more information on the [Official provider policies]({{<ref "policies.md#access" >}}) governing access, support and
more.
