...
1. Fetch your managed control plane's API server endpoint so you can provide it to Argo. In the step below, use the [up CLI]({{<ref "concepts/mcp/overview.md#connect-directly-to-your-mcp" >}}) to fetch the kubeconfig of your MCP and write it to a file.
...
1. Fetch your managed control plane's API server endpoint so you can provide it to Flux. In the step below, use the [up CLI]({{<ref "concepts/mcp/overview.md#connect-directly-to-your-mcp" >}}) to fetch the kubeconfig of your MCP and write it to a file.
