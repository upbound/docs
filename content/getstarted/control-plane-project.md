...
{{< hint type="Tip" >}}
Use the [Upbound Marketplace](marketplace.upbound.io) to discover dependencies which can be added to your project. You can also add dependencies which are private by configuring a package pull secret with the [ImageConfig API](https://docs.crossplane.io/latest/concepts/image-configs) in Crossplane. 
{{< /hint >}}
