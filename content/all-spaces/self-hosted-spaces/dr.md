...
[SpaceBackup](https://docs.upbound.io/reference/space-api/#SpaceBackup-spec) is a cluster-scoped resource that causes a single backup to occur for the whole Space.
