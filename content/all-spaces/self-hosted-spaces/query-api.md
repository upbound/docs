...
* **High Availability**: See the CloudNativePG documentation for more information on how to properly configure replication for the [PostgreSQL Cluster](https://cloudnative-pg.io/documentation/1.24/replication/) and the [Pooler](https://cloudnative-pg.io/documentation/1.24/connection_pooling/#high-availability-ha).
