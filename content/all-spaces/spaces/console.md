...
Clicking into a control plane brings you to the control plane explorer. From the control plane explorer you can learn how to integrate the control plane [with GitOps]({{<ref "gitops">}}) flows, view events, and access the control plane settings.
