...
Read the [observability documentation]({{<ref "operate/observability/">}}) to learn about the features Upbound offers for collecting telemetry from control planes.
