...
{{<img src="deploy/spaces/images/ConnectorFlow.png" alt="control plane connector operations flow" unBlur="true" lightbox="true" size="large">}}

### Control Plane Connector operations

Control Plane Connector leverages the [Kubernetes API AggregationLayer](https://kubernetes.io/docs/concepts/extend-kubernetes/api-extension/apiserver-aggregation/)
...
{{<img src="deploy/spaces/images/ConnectorMigration.png" alt="migration flow application cluster to control plane" unBlur="true" lightbox="true" size="large">}}
...
{{<img src="deploy/spaces/images/ConnectorMulticlusterArch.png" alt="Multi-cluster architecture with control plane connector" unBlur="true" lightbox="true">}}
