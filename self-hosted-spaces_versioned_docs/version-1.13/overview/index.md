...
- **[Concepts](/self-hosted-spaces/1.13/concepts/control-planes/)** — Core concepts for Spaces
- **[How-To Guides](/self-hosted-spaces/1.13/howtos/auto-upgrade/)** — Step-by-step guides for operating Spaces
- **[API Reference](/self-hosted-spaces/1.13/reference/)** — API specifications and resources
