...
This guide applies to all supported versions (v1.9-v1.14+) for self-hosted deployments. Control plane connector functionality is consistent across versions.
